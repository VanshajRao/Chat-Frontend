...
const Sidebar = ({ isOpen, toggleSidebar }) => {
    ...
    return (
        ...
        >
            <button className="md:hidden p-2 mb-4 bg-gray-900 rounded text-2xl"
      ...
      <button
          className="bg-red-600 text-white text-xl px-3 py-2 rounded-md hover:bg-red-700" onClick={logoutHandler}>
            Logout
          </button>
